...
<body class="bg-gray-100 flex">
    <aside class="w-64 bg-gray-800 text-white min-h-screen p-4">
        ...
        <nav>
            ...
            <a href="{{ route('admin.feedback.index') }}" class="block py-2.5 px-4 rounded transition duration-200 hover:bg-gray-700">
                <i class="fas fa-comment-dots mr-2"></i> Feedback
            </a>
            <a href="{{ route('admin.sessions.index') }}" class="block py-2.5 px-4 rounded transition duration-200 hover:bg-gray-700">
                <i class="fas fa-calendar-day mr-2"></i> All Sessions
            </a>
        </nav>
