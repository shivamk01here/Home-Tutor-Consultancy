...
<div class="bg-white p-8 rounded-lg shadow-md max-w-2xl mx-auto">
    ...
    <form action="{{ route('tutor.feedback.submit') }}" method="POST" class="space-y-6">
        @csrf
        <div>
        ...
        <button type="submit" class="w-full bg-green-500 hover:bg-green-600 text-white font-bold py-3 rounded-full">Submit Feedback</button>
    </form>
</div>
@endsection